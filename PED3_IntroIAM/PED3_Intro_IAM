# PED 3 – Introducción tipología de IAM

### Acceso directo (Binder)

- **Notebook 4 – Introducción al modelo 1D y a climlab**  
...
- **Notebook 5 – Respuesta al forzamiento radiativo (albedo constante)**  
...
Ejecuta los notebooks **en este orden** y sigue las instrucciones del
documento oficial de la asignatura.
